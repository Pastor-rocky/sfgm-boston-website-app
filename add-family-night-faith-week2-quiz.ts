  ...
  try {
    ...
    const questions = [
      ...
      },
      {
        ...
        type: "multiple_choice" as const,
        options: [
          "A) True — that is how biblical faith works",
          "B) False — faith trusts God before seeing results",
          "C) True — only after you see a miracle",
          "D) True — when circumstances look good",
        ],
        correctAnswer: "B) False — faith trusts God before seeing results",
        points: 1,
        orderIndex: 3,
      },
      {
      ...
      },
      {
        ...
        options: [
          "A) True",
          "B) False — you should wait until it makes sense",
          "C) False — faith is only a feeling",
          "D) False — only pastors need to act in faith",
        ],
      ...
      {
        quizId: QUIZ_ID,
        question: "What is true about God's promises?",
        type: "multiple_choice" as const,
        options: [
          "A) God never forgets His promises",
          "B) God sometimes forgets long promises",
          "C) God only keeps promises for church leaders",
          "D) God's promises depend on how we feel",
        ],
        correctAnswer: "A) God never forgets His promises",
        points: 1,
        orderIndex: 7,
      },
      {
