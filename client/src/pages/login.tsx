        ...
        <div className="max-w-md mx-auto">
          <Card className="shadow-2xl border-0 bg-white/95 backdrop-blur-sm rounded-2xl overflow-hidden">
            ...
            <CardContent className="p-8">
              ...
              <div className="mb-6">
                <Button
                  onClick={() => toast({ title: "Google Login", description: "Google login is not yet available. Please use email/username login.", variant: "default" })}
                  variant="outline"
                  className="w-full h-12 bg-white hover:bg-gray-50 border-2 border-gray-200 hover:border-blue-300 transition-all duration-300 group opacity-50 cursor-not-allowed" disabled
                >
